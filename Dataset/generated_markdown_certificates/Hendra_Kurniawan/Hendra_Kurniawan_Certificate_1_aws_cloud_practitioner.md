...
Program studi Sistem Informasi, spesialisasi Full-stack / DevOps, telah berhasil
...
| Keterangan | Nilai |
|---|---|
| Nama Penerima | Hendra Kurniawan |
| Judul Sertifikasi | AWS Cloud Practitioner |
| Penyelenggara / Issuer | Amazon Web Services (AWS) Training and Certification |
| Tanggal Terbit | 17 September 2023 |
| Berlaku Hingga | 17 September 2025 |
| Durasi Pelatihan | 25 jam |
| Skor Akhir | 81/100 |
| ID Kredensial | CERT-ACP-GN1TJ741 |
| Kode Verifikasi | PZ4278PALWKK |
