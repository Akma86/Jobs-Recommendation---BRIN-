...
menyelesaikan seluruh materi dan penilaian pada program **"CompTIA Network+ (N10-008)"**
...
| Judul Sertifikasi | CompTIA Network+ (N10-008) |
| Penyelenggara / Issuer | CompTIA |
| Tanggal Terbit | 15 Juni 2024 |
| Berlaku Hingga | 15 Juni 2027 |
| Durasi Pelatihan | 75 jam |
| Skor Akhir | 840/900 |
| ID Kredensial | CERT-COMPTIA_-908634 |
| Kode Verifikasi | VER-403042 |

---

## Cakupan Materi

- Network architectures & Ethernet standards
- Network monitoring & traffic analysis (Wireshark)
- Network hardening & VPN tunnels
