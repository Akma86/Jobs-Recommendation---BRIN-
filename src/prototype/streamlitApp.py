...
try:
    from full_pipeline import run_pipeline, JOBS_CSV_PATH, COURSE_CLO_CSV_PATH, TOP_N_OUTPUT  # type: ignore
    from shap_explain import generate_shap_report  # type: ignore
