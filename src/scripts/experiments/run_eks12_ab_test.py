...
def main():
    print("==========================================================================")
    print("EKS12: A/B Testing + Real Dynamic DiCE Counterfactuals (Online Courses)")
    print("==========================================================================")
    ...
    for idx, khs_file in enumerate(khs_files, 1):
        ...
        try:
            ...
            # 3. Run DiCE Counterfactual Explanations with Dynamic Online Course Catalog
            print(f"  [XAI] Generating DiCE counterfactuals with Online Course catalog for {student_name}...")
            ...
            dice_df = generate_dice_report(
                ...
                target_job_ids=df_after.head(5)["job_id"].tolist(),
                top_k=5,
        ...
        print(f"  [DONE] Completed recommendation & DiCE for {student_name}")

    print("\n==========================================================================")
    print("EKS12 COMPLETED SUCCESSFULLY!")
