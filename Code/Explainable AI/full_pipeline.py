...
from explainability import explain_course_match, explain_semantic_match, explain_khs_contribution, explain_cert_contribution
from shap_explain import generate_shap_report
...
def main():
    ...
    print("\n=== Stage 7: SHAP explanation (decision layer) ===")
    ...
    generate_shap_report(
        ...
        csv_path="shap_explanations.csv", plots_dir="shap_plots", n_plots=5,
    )
